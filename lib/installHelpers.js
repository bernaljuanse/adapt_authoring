...
var DEFAULT_GITHUB_ORG = 'bernaljuanse'; // used to pull releases from
var DEFAULT_SERVER_REPO = `https://github.com/bernaljuanse/adapt_authoring.git`;
var DEFAULT_FRAMEWORK_REPO = `https://github.com/bernaljuanse/adapt_framework.git`;
